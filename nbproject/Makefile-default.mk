...
SOURCEFILES_QUOTED_IF_SPACED=D_Clock.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/D_Clock.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/D_Clock.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/D_Clock.p1

# Source Files
SOURCEFILES=D_Clock.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/D_Clock.p1: D_Clock.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/D_Clock.p1.d 
	@${RM} ${OBJECTDIR}/D_Clock.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/D_Clock.p1 D_Clock.c 
	@-${MV} ${OBJECTDIR}/D_Clock.d ${OBJECTDIR}/D_Clock.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/D_Clock.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
